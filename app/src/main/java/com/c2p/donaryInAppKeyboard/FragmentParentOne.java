...
public class FragmentParentOne extends Fragment {
    ...
    static FragmentParentOne newInstance(int num, int color) {
        FragmentParentOne f = new FragmentParentOne();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_parent_one, container, false);
